 ...
 * UNDONE 1:横幅と縦幅のアニメーションと移動のアニメーションがくっついてしまっていて、移動の方にだけGravityPathMotionをかけたいができていない
 * UNDONE 2:RecyclerViewの右側にあるImageViewから遷移した場合にアニメーションが真ん中に寄ってしまっている。
 * 　(たぶんchangeImageTransformと競合しておかしいことになっている？)
 */
